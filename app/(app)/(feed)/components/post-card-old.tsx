...
const PostCard: React.FC<PostCardProps> = React.memo(({ item, onImagePress }) => {
  ...
  return (
    <TouchableOpacity onPress={()=> router.navigate({
      ...
      })} activeOpacity={.8} style={[styles.cardContainer, { backgroundColor: colours.background.strong, shadowColor: colours.text.default }]}>
      ...
      {renderContent}
        ...
        <RamaHStack  style={styles.actionsContainer}>
          {renderActionButton('shared', 'star-outline', "gold", 'Star post')}
