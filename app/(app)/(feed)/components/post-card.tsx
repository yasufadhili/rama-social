...
const PostCard: React.FC<PostCardProps> = ({ item, onImagePress }) => {
  ...
  const renderHeader = () => (
    <BlurView intensity={60} tint={"dark"} style={{ paddingLeft: 4, paddingVertical: 12 }}>
    ...
    return (
      <>
        <LinearGradient
          ...
          style={[{ borderRadius: 18, overflow: "hidden", paddingBottom: 8, marginBottom: 12, marginHorizontal: 0 }]}
        >
          {renderHeader()}
          <View style={{
            alignItems: "center",
  ...
  const renderMediaContent = () => (
    <View style={{ borderRadius: 18, overflow: "hidden", marginHorizontal: 0, marginBottom: 12, backgroundColor: colourTheme === "dark" ? colours.background.soft : colours.background.strong }}>
      {renderHeader()}
